function Show-AIInfoWindow {
    ...
    $gen = New-Card "GENERATION SETTINGS" 306
    Add-FieldRow $gen 56  "Seed"         $data.seed
    Add-FieldRow $gen 88  "Seed Source"  $data.seed_source
    Add-FieldRow $gen 120 "Steps"        $data.steps
    Add-FieldRow $gen 152 "CFG"          $data.cfg
    Add-FieldRow $gen 184 "Sampler"      $data.sampler
    Add-FieldRow $gen 216 "Scheduler"    $data.scheduler
    Add-FieldRow $gen 248 "Source Tag"   $data.source_tag
    ...
    $tagsCard = New-Card "Found Tags" 226
